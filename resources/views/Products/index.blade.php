...
<body>
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							...
							<a href="{{route('cart.index')}}" class="btn w3view-cart"  name="submit" value="">
									<i class="fas fa-cart-arrow-down">Panier <span style="color: white" class="badge badge-pill bg-dark">{{Cart::Count()}}</span></i>
							</a>
								</form>
							</div>
						</div>
	...
	<h3 style="margin-top: 10px" class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
		<span>O</span>ur
		<span>N</span>ew
		...
		<div class="container">
			...
			<div class="nav-scroller py-1 mb-2">
				<nav class="nav d-flex justify-content-between">
					...
					<a class="text-success" href="{{route('products.index',['categorie'=>$category->slug])}}" class="p-2 text-muted">{{$category->name}}</a>
				  @endforeach
				</nav>
			  </div>
	  <div class="row mb-2">
		...
		@foreach($products as $product)
                <div class="col-md-6 agileinfo-ads-display">
                       <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
						   ...
						   <a href="{{route('products.show',$product->slug)}}" name="submit1" style="background-color: #0879c9"  class="btn btn-primary">Voir le produit</a>
						   </div>

						   <div class="col-auto d-none d-lg-block   men-thumb-item text-center mt-5 d-none d-lg-block">
							<img  class="bd-placeholder-img" src="{{$product->image}}" alt="">
					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row ">
								...
								<div class="col-md-6 no-gutters flex-md-row mb-4 h-md-250 position-relative product-men mt-5">
	...
	<!-- footer 
	<footer>
		<div style="width: 100%" class="footer-top-first">
